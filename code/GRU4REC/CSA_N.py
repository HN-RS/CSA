...
if __name__ == '__main__':
    ...
    train_noise_ = tf.random_normal([args.num_aug, args.batch_size, args.hidden_factor], 0.0, args.sigma, seed=2022)
    train_noise_1 = tf.random_normal([args.num_aug, args.batch_size, args.hidden_factor], 0.0, args.sigma, seed=10)
