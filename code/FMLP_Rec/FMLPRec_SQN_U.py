...
class FMLPRecModel:
    def __init__(self, hidden_size, learning_rate, item_num, state_size, name='FMLPRecModel'):
        ...
        with tf.variable_scope(self.name):
            ...
            item_encoded_layers = item_encoder(args, self.sequence_emb, extended_attention_mask, self.complex_weight,
            ...
            self.loss = tf.reduce_mean(args.q_w * self.celoss + self.qloss)
...
def evaluate(sess):
    ...
    while evaluated < len(eval_ids):
        ...
        prediction = sess.run(FMLPRec1.output2, feed_dict={FMLPRec1.inputs: states, FMLPRec1.len_state: len_states,
                                                         FMLPRec1.is_training: False, FMLPRec1.noise: noise})
