...
class FMLPRecModel:
    def __init__(self, hidden_size, learning_rate, item_num, state_size, name='FMLPRecModel'):
        ...
        with tf.variable_scope(self.name):
            ...
            self.output1 = tf_slim.fully_connected(self.state_hidden, self.item_num, activation_fn=None,
                                                   scope='q-value')

            self.output2 = tf_slim.fully_connected(self.state_hidden, self.item_num, activation_fn=None,
                                                   scope="ce-logits")
            ...
            self.loss = tf.reduce_mean(celoss + args.q_w * qloss)
