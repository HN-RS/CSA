...
class SASRecnetwork:
    def __init__(self, hidden_size, learning_rate, item_num, state_size, args, name='DQNetwork'):
        ...
        with tf.variable_scope(self.name):
            ...
            self.states_hidden_aug0 = tf.expand_dims(self.state_hidden, 0)
            ...
            self.output2 = tf_slim.fully_connected(self.state_hidden, self.item_num,
            ...
            self.targetQs_selector = tf.placeholder(tf.float32, [args.num_aug + 1, None,
...
def evaluate(sess):
    ...
    while evaluated < len(eval_ids):
        ...
        prediction = sess.run(SASRec1.output2, feed_dict={SASRec1.inputs: states, SASRec1.len_state: len_states,
                                                          SASRec1.is_training: False, SASRec1.noise: noise})
