...
def evaluate(sess):
    ...
    while evaluated < len(eval_ids):
        ...
        for i in range(batch):
            ...
            evaluated += 1
        prediction = sess.run(SASRec.output, feed_dict={SASRec.inputs: states, SASRec.len_state: len_states,
                                                        SASRec.is_training: False})
...
if __name__ == '__main__':
    ...
    SASRec = SASRecnetwork(hidden_size=args.hidden_factor, learning_rate=args.lr, item_num=item_num,
